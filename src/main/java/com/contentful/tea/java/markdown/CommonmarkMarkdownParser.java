package com.contentful.tea.java.markdown;
...
/**
 * Implementation of {@link MarkdownParser} using the commonsmark markdown parser.
 */
@Component
...
public class CommonmarkMarkdownParser implements MarkdownParser {
   ...
   */
  @Override public String parse(String toParse) {
    if (toParse != null) {
      ...
      final String html = renderer.render(node);
      return html;
    } else {
      return null;
    }
